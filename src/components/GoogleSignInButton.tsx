...
export const GoogleSignInButton: React.FC<GoogleSignInButtonProps> = ({ 
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className={`w-full h-12 text-lg font-medium bg-white hover:bg-gray-50 text-gray-900 rounded-xl border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] flex items-center justify-center gap-2 ${className}`}
    >
